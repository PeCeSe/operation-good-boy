...
const STARTING_CARDS = {
  ...
  persian_pedigree: {
    ...
    effect: { attack: 0, attackType: null, pawcoins: 0, special: "choice_pedigree" },
  ...
  persian_mirror: {
    ...
    effect: { attack: 0, attackType: null, pawcoins: 1, special: "discard_all_gain_coin" },
  ...
  persian_slave: {
    ...
    effect: { attack: 0, attackType: null, pawcoins: 0, special: "choice_ignore_or_heal2" },
    description: "Choose: Gain 1 🙄 ignore or heal 2 ♥.",
