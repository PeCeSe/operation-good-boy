  ...
  return (
    <div className="flex items-end gap-6 flex-wrap">
      ...
      <button
        ...
        onClick={handleDraw}
        disabled={deckCount === 0}
        className={`absolute rounded-lg border-2 overflow-hidden select-none transition-all ${
          deckCount > 0
        ...
        style={{ width: 213, height: 213, top: deckCount > 2 ? 0 : deckCount > 1 ? 3 : 6, left: deckCount > 2 ? 0 : deckCount > 1 ? 3 : 6, touchAction: "none" }}
