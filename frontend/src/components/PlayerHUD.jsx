  ...
  return (
    <button
      ...
      className={`
        ...
        ${isActive
          ? "bg-paper-100 text-ink-700 border-ink-border/20 border-b-[#fbf1da] translate-y-[2px] relative z-10"
          : "bg-paper-200/60 text-ink-400 border-ink-border/20 border-b-transparent hover:text-ink-600 hover:bg-paper-200/80"
        }
      `}
    >
      {headshot && (
